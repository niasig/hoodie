...
object SparkParquetSchemaConverters {

    @transient lazy private val schemaConverter  = new SparkParquetSchemaConverters(
        writeTimestampInMillis = true,
        writeLegacyParquetFormat = true
    )

    def convert(sparkSchema: StructType): MessageType = {
        schemaConverter.convert(sparkSchema)
    }
...
/**
  ...
  *
  */
private[parquet] class SparkParquetSchemaConverters (
    ...
    import SparkParquetSchemaConverters._
